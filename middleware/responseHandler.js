...
const responseHandler = () => async (req, res, next) => {
    ...
    res.success = ({ statusCode, result = null, msg = null }) => {
        const responseStatus = statusCode && statusCode < statusCodes.MULTIPLE_CHOICES && statusCode >= statusCodes.OK ? statusCode : statusCodes.OK
      ...
      /* 300 responses */ statusCode,
        ...
        const responseStatus =
            statusCode &&
                ...
                statusCode >= statusCodes.MULTIPLE_CHOICES
                ? statusCode
